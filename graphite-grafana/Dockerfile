...
RUN /etc/init.d/mysqld start && \
  ...
  sleep 1
#
RUN cd /var/www/html && wget http://grafanarel.s3.amazonaws.com/grafana-1.5.4.tar.gz
RUN cd /var/www/html && tar zxvf grafana-1.5.4.tar.gz && ln -s /var/www/html/grafana-1.5.4 /var/www/html/grafana
